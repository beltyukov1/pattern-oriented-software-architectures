...
public class LoginActivity extends StoryActivityBase{
    ...
    /* TODO: Commented out MAX_SECURITY since it was being passed when creating login.txt file
             and had a value outside the scope of SECURITY_PUBLIC and SECURITY_PRIVATE constants
             in StorageUtilities class */
	...
	public static File getLoginFile (Context context) {
		return StorageUtilities.getOutputMediaFile(context, 	// Line 48
				...
				StorageUtilities.SECURITY_PRIVATE, // TODO: replaced MAX_SECURITY with SECURITY_PRIVATE
				"login.txt");
	}

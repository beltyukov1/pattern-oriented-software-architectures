...
public class PingPongRight {
    ...
    public static class PlayPingPongThread extends Thread {
        ...
        public void run() {
            ...
            // TODO - You fill in here.
            for (int currentIteration = 1; currentIteration <= mMaxLoopIterations; ++currentIteration) {
                acquire();
                System.out.println(stringToPrint + '(' + currentIteration + ')');
                release();
            }
        ...
        private void acquire() {
            // TODO fill in here
            simpleSemaphores[FIRST_SEMA].acquireUninterruptibly();
        }
